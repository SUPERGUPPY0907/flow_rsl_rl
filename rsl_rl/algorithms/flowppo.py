...
class FlowPPO:
    ...
    def act(self, obs, critic_obs):
        ...
        actions, actions_log_prob = self.policy.act1(obs, jac=True)
        # breakpoint()
    ...
    def update(self):  # noqa: C901
        ...
        for (
            ...
            # if i ==0:
            #     for name, param in self.policy.actor1.named_parameters():
            ...
            actions_log_prob_batch = self.policy.inverse_ode1(obs_batch, actions_batch, jac=True)
            # -- critic
