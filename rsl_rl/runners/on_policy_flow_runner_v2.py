...
import rsl_rl
from rsl_rl.algorithms import PPO, FlowPPO, FlowPPO_v2, Distillation
...
from rsl_rl.rsl_rl.modules import ActorCriticFlow_v2


class OnPolicyFlowRunner_v2:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        policy: ActorCritic | ActorCriticFlow | ActorCriticFlow_v2 | ActorCriticRecurrent | StudentTeacher | StudentTeacherRecurrent = policy_class(
    ...
    def learn(self, num_learning_iterations: int, init_at_random_ep_len: bool = False):  # noqa: C901
        ...
        for it in range(start_iter, tot_iter):
            start = time.time()
            # Rollout
            # TODO： with torch.inference_mode(): disables autograd in a way that cannot be re-enabled by torch.enable_grad(). with torch.no_grad(): is used here
            with torch.no_grad():
